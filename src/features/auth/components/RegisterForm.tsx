...
export function RegisterForm() {
  ...
  return (
    <AuthWrapper
      ...
      description="Join our secure knowledge community today"
    >
      <form onSubmit={handleSubmit(onSubmit)}>
        <CardContent className="space-y-4">
          <div className="space-y-2">
            ...
            <Input
              ...
              {...register("name")}
            />
            {errors.name && <p className="text-xs font-medium text-destructive animate-in fade-in slide-in-from-top-1">{errors.name.message}</p>}
          </div>
          <div className="space-y-2">
        ...
        <CardFooter className="flex flex-col gap-4 pt-6">
          ...
          <div className="text-sm text-center text-muted-foreground">
            ...
            <Link href="/login" className="font-semibold text-primary hover:underline underline-offset-4 decoration-2">
              Sign In
            </Link>
          </div>
        </CardFooter>
